...
export default function ConfiguracaoPrestador({navigation, route}) {
  ...
  return (
    <View style={styles.main}>
      ...
      <View style={{width : '90%', paddingTop:20}}>
        ...
        <TouchableOpacity>
            <Text style={{color: colors.color1, fontFamily: "Fredoka-Bold", fontSize: RFPercentage(3), paddingVertical: 15}}>Editar Chatbot</Text>
            <View style={{backgroundColor : colors.color1, height: 1, width : '100%'}}></View>
        </TouchableOpacity>
