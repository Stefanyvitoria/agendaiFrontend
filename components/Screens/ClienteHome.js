...
function body(navigation,tabAtual, ano, setAno, mes, setMes, dia, setDia) {
  ...
  if (tabAtual == 'Início') {
    ...
    agendamentos = [
      {
      servicos: [
          {nome: 'Estabelecimento 1', horario: "8:00 - 08:45", valor: "Preço: R$ xx,xx"},
          {nome: 'Estabelecimento 2', horario: "11:40 - 12:00", valor: "Preço: R$ xx,xx"}
      ]},
      {
      servicos: [
          {nome: 'Estabelecimento 3', horario: "09:00 - 09:30", valor: "Preço: R$ xx,xx"},
          {nome: 'Estabelecimento 1', horario: "14:00 - 15:15", valor: "Preço: R$ xx,xx"}
      ]}
  ...
  if (dataCalendario.getDay() == 1 ) {
    ...
    return (
      <View style={styles.agenda}>
                 ...
                 <ScrollView style={{backgroundColor: 'white', width: width, flexGrow: 1}}>
                        ...
                        <FlatList
                            ...
                            renderItem={ ({item}) => (
                                ...
                                :<TouchableOpacity onPress={() => {
                                    ...
                                    style={{marginVertical : 10,backgroundColor : colors.color1, width: (width-40)/7, margin : 1, alignItems : 'center', backgroundColor: item == dia ? 'green': colors.color1, borderRadius: item == dia ? 15: 0}}>
                                    <Text style={{color: colors.color5 ,fontSize: RFPercentage(2), fontFamily : item == dia ? "Fredoka-Bold" : "Fredoka-Regular"}}>{item}</Text>
                                </TouchableOpacity>
                            )}
                        />
                    </View>

                    <ScrollView style={{backgroundColor : colors.color4, marginBottom: 2, flexGrow: 1, height: height*0.41}}>
                    <Text style={{color: colors.color2, fontFamily :"Fredoka-Bold", fontSize:RFPercentage(3), alignSelf: 'center'}}>Agendamentos</Text>
                    ...
                    return (
                        <View style={{backgroundColor : colors.color4, alignItems: 'center', marginBottom: 2}}>
                            ...
                            {item.servicos.map((item2, index2) => {
                                return (
                                    <TouchableOpacity  key={index2} style={{backgroundColor : colors.color2, marginHorizontal : 20, marginVertical : 5, paddingVertical: 10, paddingHorizontal: 15, borderRadius: 10, width : '90%'}}>
                                        <Text style={{color: 'white', fontFamily :"Fredoka-Bold", fontSize:RFPercentage(2.5)}}>{item2.nome}</Text>
                                        
                                        <View style={{flexDirection: 'row', justifyContent:'space-between'}}>
                                            <View>
                                                <Text style={{fontFamily: 'Fredoka-Regular', color: 'white', fontSize: RFPercentage(2)}}>{item2.valor}</Text>
                                
                                            </View>
                                            <Text style={{color: 'white',fontFamily: 'Fredoka-Bold', fontSize: RFPercentage(3)}}>{item2.horario}</Text>
                                        </View>
